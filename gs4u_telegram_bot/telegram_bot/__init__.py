...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup.from_button(
            KeyboardButton(
                text="Мониторинг",
                web_app=WebAppInfo(url=f"https://www.gs4u.net/en/webmod/frame-map:120;splr:1;players:210;mfs:100;mac:6d6d6d;mahc:8f8f8f;sna:d59120;mbg:1d1d1d;bg:4d4d4d;fg:ffffff;snb:666666;itc:aaaaaa;shs:1;/s/{id}.html"),
            )
        ),
    )
...
async def show_current_info(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
